                            ...
                            <div class="card-body">{{ $key }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mt-2 border-secondary"
                                        ...
                                        <option value="">(選択してください)</option>
                                        <option value="{{ is_object($school) ? $school->course_type : ($school['course_type'] ?? '') }}" selected>
                        ...
                        <div class="card mb-4 shadow-sm border rounded-3 career-form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border-secondary"
                                        name="careers[0][company_name]" value="{{ $career->company_name }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control border-secondary"
                                        name="careers[0][capital]" value="{{ $career->capital }}"> 円
                                ...
                                <!-- 期間 -->
                                @php
                                    $entryYear = !empty($career->entry_day_year) ? (int) $career->entry_day_year : '';
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select border-secondary" name="careers[0][working_type_code]">
                                        <option value="">(選択してください)</option>
                                        <option value="{{ $career->working_type_code }}" selected>
                                            {{ $career->working_type }}
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control border-secondary" name="careers[{{ $key }}][business_detail]" rows="4">{{ old('careers.' . $key . '.business_detail', $career->business_detail) }}</textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select border-secondary mb-2" name="careers[0][job_type_big_code]"
                                    ...
                                    <option value="">▼大分類</option>
                                    @foreach ($jobTypes->unique('big_class_code') as $type)
                                        <option value="{{ $type->big_class_code }}">{{ $type->big_class_name }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('careers.0.job_type_big_code')
