<div class="container bg-white border p-4" style="max-width: 850px;">
    ...
    <form wire:submit.prevent="save" class="container px-3 py-4" style="max-width: 850px;">
        ...
        <div class="row g-3">
            ...
            {{-- 氏名・フリガナ --}}
            <div class="col-md-6">
                <label class="form-label">お名前 (漢字)</label>
        ...
        {{-- 🎓 学歴情報 --}}
        <div class="mt-5">
            <h5 class="fw-medium text-primary">学歴 <span class="text-main-theme fs-f14">必須</span></h5>
        ...
        {{-- 💼 職歴情報 --}}
        <div class="mt-5">
            <h5 class="fw-medium text-primary">職歴 <span class="text-main-theme fs-f14">必須</span></h5>
            {{-- 💼 職歴情報 --}}
        ...
        <div class="col-12 mb-5">
            ...
            <textarea class="form-control border-dark" rows="5" wire:model.lazy="self_pr" placeholder="ここに自己PRを入力してください"></textarea>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        @error('commute_time') <div class="text-danger small scroll-target">{{ $message }}</div> @enderror
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control border-dark" rows="5" wire:model.defer="resumePreference.wish_motive"></textarea>
                    @error('resumePreference.wish_motive') <div class="text-danger small scroll-target">{{ $message }}</div> @enderror
                    <small class="text-muted">※履歴書へ表示されるのは全角200文字までです。(出力形式により多少前後します。)</small>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control border-dark" rows="5" wire:model.defer="resumePreference.hope_column"></textarea>
                    @error('resumePreference.hope_column') <div class="text-danger small scroll-target">{{ $message }}</div> @enderror
                    <small class="text-muted">※履歴書へ表示されるのは全角200文字までです。(出力形式により多少前後します。)</small>
