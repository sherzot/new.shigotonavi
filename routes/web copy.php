...
// 求人を更新する！
Route::get('/agent/{orderCode}/agentJobEdit', [AgentDashboardController::class, 'showEditJobPage'])->name('agent.agentJobEdit');
Route::put('/agent/{orderCode}', [AgentDashboardController::class, 'updateJob'])->name('agent.update');
// 採用企業の方へ
