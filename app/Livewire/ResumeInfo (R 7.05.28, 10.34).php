...
class ResumeInfo extends Component
{
    ...
    public function save()
    {
        ...
        $this->validate([
            ...
            'school_name'=>'学校名は必須です',
            'company_name'=>'企業名は必須です',
        ...
        try {
           ...
           // 🔒 各職歴行をチェック
            ...
            foreach ($this->careers as $index => $career) {
                ...
                $jobTypeCode = $jobTypeBig . $jobTypeSmall . '000';
            ...
            // $this->dispatch('savedAndScroll', ['message' => '保存に成功しました。', 'scrollTo' => 'searchJob']);
            // $this->dispatch('savedAndScroll', [
            //     'message' => '保存に成功しました。',
            //     'scrollTo' => 'searchJob'
            // ]);
            
            $this->dispatch('resumeCompleted'); // Livewire blokini yangilash uchun
